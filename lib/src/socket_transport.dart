...
class SocketTransport {
  SocketTransport(List<SocketInterface>? sockets,
    ...
    for (SocketInterface socket in sockets) {
  ...
  late void Function(SocketInterface? socket, int? attempts) onconnecting;
  late void Function(SocketInterface? socket, ErrorCause cause) ondisconnect;
  ...
  void disconnect() {
    ...
    socket.onconnect = () => () {};
    socket.ondisconnect =
        (SocketInterface socket, bool error, int? closeCode, String? reason) =>
            () {};
  ...
  bool send(dynamic data) {
    ...
    print("TXP socket transport sending");
  ...
  void _onData(dynamic data) {
    ...
    // Binary message.
      ...
      print('TXP receiving: ${data.toString()}');
