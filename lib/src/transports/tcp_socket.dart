...
class TcpSocket extends SocketInterface {
  TcpSocket(String host, String port,
  ...
  void connect() async {
    ...
    try {
      _tcpSocketImpl =
          TcpSocketImpl(_messageDelay, _host ?? '0.0.0.0', _port ?? '5060');
